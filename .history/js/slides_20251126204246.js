export class SlideViewer {
  ...
  async _ensurePdfLib() {
    ...
    if (window.ensurePdfJs) {
      ...
      if (!ok) throw new Error('pdf.js library failed to load from CDN (jsDelivr + Cloudflare)');
    } else {
    ...
    if (window.pdfjsLib && !window.pdfjsLib.GlobalWorkerOptions.workerSrc) {
      window.pdfjsLib.GlobalWorkerOptions.workerSrc = 'https://cdn.jsdelivr.net/npm/pdfjs-dist@3.11.313/build/pdf.worker.min.js';
    }
