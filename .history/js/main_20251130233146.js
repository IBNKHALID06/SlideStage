...
const startRecording = async () => {
  try {
    ...
    // Priority: MP4 (Generic) -> WebM (VP9) -> WebM (VP8) -> WebM (Default)
    // Note: We removed 'video/webm;codecs=h264' because it often causes green/glitchy video on Windows.
    const mimeTypes = [
      'video/mp4',                                 // Try generic MP4 first (let browser pick best profile)
      'video/webm;codecs=vp9,opus',                // VP9 (High Quality, very stable)
      'video/webm;codecs=vp8,opus',                // VP8 (Standard, compatible)
