export class Subtitles {
  ...
  async _loadVoskLib() {
    ...
    // Try loading from a different CDN structure or latest version
    const urls = [
      'https://cdn.jsdelivr.net/npm/vosk-browser@0.0.9/dist/vosk.js',
      'https://unpkg.com/vosk-browser@0.0.9/dist/vosk.js',
      'https://cdn.jsdelivr.net/npm/vosk-browser/dist/vosk.js' // Latest
    ];
    ...
    throw new Error('Failed to load Vosk library from all CDNs. Please check your internet connection.');
  }
